...
There is no universally agreed upon definition of the Sexual and Reproductive Health and Rights (SRHR) but {% tooltip Defined at the 1994 UNFPA International Conference in Cairo. An opinion piece on the role of the conference in the development of SRHR: <a href='https://www.jstor.org/stable/2950752?seq=1#page_scan_tab_contents'>https://www.jstor.org/stable/2950752?seq=1#page_scan_tab_contents</a> %}the most widely recognised one{% endtooltip %} is as follows: "the right of men and women to be informed and to have access to safe, effective, affordable and acceptable methods of family planning of their choice, as well as other methods of their choice for regulation of fertility which are not against the law, and the right of access to appropriate health-care services that will enable women to go safely through pregnancy and childbirth and provide couples with the best chance of having a healthy infant."

While always having been highlighted by feminists as an important determinant of a woman’s life and freedom in general, reproductive rights only became legally recognised as a separate subset of fundamental rights in {% tooltip Created during the first UN Conference exclusively on human rights. The full document:  <a href='https://web.archive.org/web/20071017025912/http://www.unhchr.ch/html/menu3/b/b_tehern.htm'>https://web.archive.org/web/20071017025912/http://www.unhchr.ch/html/menu3/b/b_tehern.htm</a> %}the 1968 Proclamation of Teheran{% endtooltip %}. As a result, there has since been a clear progress in the last few decades evidenced by the significant drop in {% tooltip MMR indicates how many women die per year due to pregnancy or childbirth-related complications. Key facts explained by the World Health Organization: <a href='http://www.who.int/mediacentre/factsheets/fs348/en/'>http://www.who.int/mediacentre/factsheets/fs348/en/</a> %}global maternal mortality ratio{% endtooltip %} with Europe becoming the frontrunner in fight for reproductive freedom. In addition, the attention in the last decade has slowly shifted from solely dealing with the issues of maternal mortality, {% tooltip STIs are infections that are passed on through unprotected sex and genital contact or genetically. List of most spread STIs: <a href='http://www.nhs.uk/conditions/Sexually-transmitted-infections/Pages/Introduction.aspx'>http://www.nhs.uk/conditions/Sexually-transmitted-infections/Pages/Introduction.aspx</a> %}transmission of Sexually Transmitted Infections(STIs){% endtooltip %} and {% tooltip Unsafe abortions are procedures where the pregnancy is terminated either by people lacking the necessary qualifications or in an environment with unsatisfactory medical standards %}unsafe abortions{% endtooltip %} to promoting {% tooltip Comprehensive sexuality education is a 12-year school programme that aims to freely inform the children on various aspects of sex and relationships and emphasises the importance of choice. More information on how this particular programme differs from other sex ed programmes:  <a href='http://www.siecus.org/index.cfm?fuseaction=page.viewpage&pageid=521&grandparentID=477&parentID=514'>http://www.siecus.org/index.cfm?fuseaction=page.viewpage&pageid=521&grandparentID=477&parentID=514</a> %} comprehensive sexuality education{% endtooltip %}, {% tooltip Family planning allows couples to attain the desired number of children through contraceptive use, sterilisation and treatment of infertility %}family planning{% endtooltip %} and contraceptive use in adolescents.

However, the above-mentioned shift also serves to highlight the already obvious disparity across the continent in the range of problems different regions face. The difference in maternal mortality rates not only demonstrates how Eastern European states are failing to keep up with their western neighbours  but also point to the socio-economic aspect of the issue as the majority of victims come from low income families. Thus, despite {% tooltip SRHR are recognised by the UN, European Court of Human Rights and the vast majority of national governments as a basic human right. However, the definitions of SRHR and thus, their implementation differs from country to country.%}being recognised as a basic human right by international community{% endtooltip %}, SRHR are still to some extent treated as a privilege denied to socially and economically vulnerable groups.
...
<br>
<img src="img/femm_1.png" class="overview-img" />
<br>
...
The main competence regarding the implementation of the SRHR still lies in the **National Governments** as they freely determine the legal framework of abortion, contraceptive use and national curricula. As already mentioned, the existing legislations of Ireland and Poland were not revised even after {% tooltip The European Court declared Ireland’s and Poland’s policies on abortion to be a breach to the fundamental rights as the right to private life should guarantee women's’ ability to get safe abortions. More on both cases and arguments used by the Court: <a href='http://www.echr.coe.int/Documents/FS_Reproductive_ENG.pdf'>http://www.echr.coe.int/Documents/FS_Reproductive_ENG.pdf</a> %}the European Court of Human Right’s ruling{% endtooltip %} which once again demonstrates how strong the Member States’ stance is regarding keeping their policies the same.

As the EU is only allowed to support and coordinate the Member States’ actions, it proposes health-related legislation and monitors the said sector through the the **European Commission’s Directorate Generals on Health and Food Safety** (DG SANTE). While it is evident that the Union is in favour of further improving the SRHR, the failure to adopt the {% tooltip Highly criticised by the anti-choice advocates, the so-called 'Estrela report' was a proposed non-binding EU resolution that promoted the right to safe abortion in every Member State. An article with further information on the report and the close vote:  <a href='https://euobserver.com/social/122418'>https://euobserver.com/social/122418</a> %}“Estrela report” in 2013{% endtooltip %} proves that the high range of opinions among the Member States makes the organisation take a step back on the issue.
...
**Guaranteeing access to affordable quality health centres** for women of all socioeconomic backgrounds has remained a critical issue particularly in Eastern European states due to the high costs of STI testing, abortion and other services as well as public clinics being viewed as untrustworthy because of cases of violated anonymity. Affordability of such services poses the biggest challenge for the most vulnerable groups such as {% tooltip An opinion piece critical of the EU’s treatment of migrants’ SRHR-related issues: <a href='http://www.sciencedirect.com/science/article/pii/S0168851013002881'>http://www.sciencedirect.com/science/article/pii/S0168851013002881</a> %}**adolescents, immigrants and Internally Displaced Persons (IDP)**{% endtooltip %}. In addition, the level of availability of health centres tends to be much lower in rural areas. As a result, women frequently refer to life-threatening practices such as {% tooltip Article on alarming rates of unsafe abortion procedures in Eastern Europe:  <a href='http://www.ipsnews.net/2012/11/unsafe-abortions-threaten-thousands-in-eastern-europe/'>http://www.ipsnews.net/2012/11/unsafe-abortions-threaten-thousands-in-eastern-europe/</a> %}**unsafe abortion procedures or non-medical diagnostic testings**{% endtooltip %}.
...
The disparity between regions is also demonstrated by the Member States’ treatment of **sexuality education** and its curricula which is determined by every national government individually. While some countries like Denmark and Sweden highlight more and more the subject’s social and emotional aspects covering the topics like LGBTIQA+, sexual consent, and teen relationships, more conservative states such as Slovakia and Poland tend to treat solely the biological aspect of reproduction or push towards abstinence as a means to prevent sexual health-related problems. Lastly, in non-EU states such as Georgia, Armenia and Ukraine the sexuality education classes are basically non-existent due to the pressures from highly influential religious groups. The same conservative groups also oppose the implementation of the {% tooltip UNFPA guide on why the HPV vaccines are necessary and how they can be implemented on a national level:  <a href='https://www.unfpa.org/sites/default/files/resource-pdf/hpv_vaccines.pdf'>https://www.unfpa.org/sites/default/files/resource-pdf/hpv_vaccines.pdf</a> %}**Human Papillomavirus (HPV) vaccine**{% endtooltip %} in efforts to avoid defining so-called sexual maturity of underage females.

The said disparity between states causes many activists to push for the EU to make certain education-related standards mandatory on the basis that the sexuality education is {% tooltip Common safety concerns in public health, unlike education, constitutes a shared competence between the EU and the Member States and given its role in informing the youth on SRHR, sexuality education is believed by some to be a public health concern and thus a shared responsibility of the EU and the Member States.%}part of the public health{% endtooltip %} as well. However, the government's opinion remains to be that the EU is not competent in the education field and thus, that its contribution should be limited to funding of programmes.

## Measures in place

In 2015, the European Parliament adopted a resolution, so called **"Tabarella report"** where the Union acknowledged the right to abortion as a basic human right but at the same time once again underlined the Member States’ ability to freely determine the national policy on SRHR issues reinforcing {% tooltip “Everyone has the right of access to preventive health care and the right to benefit from medical treatment under the conditions established by national laws and practices. A high level of human health protection shall be ensured in the definition and implementation of all Union policies and activities.” %}**the article 35 of the Charter of Fundamental Rights of the European Union (CFR)**.{% endtooltip %}
...
Apart from providing constant data, The WHO also created {% tooltip Full document: <a href='http://www.euro.who.int/__data/assets/pdf_file/0004/69529/e74558.pdf'>http://www.euro.who.int/__data/assets/pdf_file/0004/69529/e74558.pdf</a> %}**European regional strategy on sexual and reproductive health** in 2001{% endtooltip %} which served for the time period of 2001-2015. Another action plan for a shorter time period of 2017-2021 is being drafted right now.
...
The majority of Member States have identified the Human Papillomavirus (HPV) as a serious issue and have instituted a {% tooltip EU’s progress on HPV vaccination programmes documented by the European Centre for Disease Control: <a href='http://ecdc.europa.eu/en/publications/Publications/20120905_GUI_HPV_vaccine_update.pdf'>http://ecdc.europa.eu/en/publications/Publications/20120905_GUI_HPV_vaccine_update.pdf</a> %}vaccination programme{% endtooltip %}.
