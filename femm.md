...
There is no universally agreed upon definition of the Sexual and Reproductive Health and Rights (SRHR) but {% tooltip Defined at the 1994 UNFPA International Conference in Cairo. An opinion piece on the role of the conference in the development of SRHR:https://www.jstor.org/stable/2950752?seq=1#page_scan_tab_contents %}the most widely recognised one{% endtooltip %} is as follows: "the right of men and women to be informed and to have access to safe, effective, affordable and acceptable methods of family planning of their choice, as well as other methods of their choice for regulation of fertility which are not against the law, and the right of access to appropriate health-care services that will enable women to go safely through pregnancy and childbirth and provide couples with the best chance of having a healthy infant."

While always having been highlighted by feminists as an important determinant of a woman’s life and freedom in general, reproductive rights only became legally recognised as a separate subset of fundamental rights in {% tooltip Created during the first UN Conference exclusively on human rights. The full document: https://web.archive.org/web/20071017025912/http://www.unhchr.ch/html/menu3/b/b_tehern.htm %}the 1968 Proclamation of Teheran{% endtooltip %}. As a result, there has since been a clear progress in the last few decades evidenced by the significant drop in {% tooltip MMR indicates how many women die per year due to pregnancy or childbirth-related complications. Key facts explained by the World Health Organization: http://www.who.int/mediacentre/factsheets/fs348/en/ %}global maternal mortality ratio{% endtooltip %} with Europe becoming the frontrunner in fight for reproductive freedom. In addition, the attention in the last decade has slowly shifted from solely dealing with the issues of maternal mortality, {% tooltip STIs are infections that are passed on through unprotected sex and genital contact or genetically. List of most spread STIs:http://www.nhs.uk/conditions/Sexually-transmitted-infections/Pages/Introduction.aspx %}transmission of Sexually Transmitted Infections(STIs){% endtooltip %} and {% tooltip Unsafe abortions are procedures where the pregnancy is terminated either by people lacking the necessary qualifications or in an environment with unsatisfactory medical standards %}unsafe abortions{% endtooltip %} to promoting {% tooltip Comprehensive sexuality education is a 12-year school programme that aims to freely inform the children on various aspects of sex and relationships and emphasises the importance of choice. More information on how this particular programme differs from other sex ed programmes: http://www.siecus.org/index.cfm?fuseaction=page.viewpage&pageid=521&grandparentID=477&parentID=514 %} comprehensive sexuality education{% endtooltip %}, {% tooltip Family planning allows couples to attain the desired number of children through contraceptive use, sterilisation and treatment of infertility %}family planning{% endtooltip %} and contraceptive use in adolescents.
...
The main competence regarding the implementation of the SRHR still lies in the **National Governments** as they freely determine the legal framework of abortion, contraceptive use and national curricula. As already mentioned, the existing legislations of Ireland and Poland were not revised even after {% tooltip The European Court declared Ireland’s and Poland’s policies on abortion to be a breach to the fundamental rights as the right to private life should guarantee women's’ ability to get safe abortions. More on both cases and arguments used by the Court: http://www.echr.coe.int/Documents/FS_Reproductive_ENG.pdf %}the European Court of Human Right’s ruling{% endtooltip %} which once again demonstrates how strong the Member States’ stance is regarding keeping their policies the same.

As the EU is only allowed to support and coordinate the Member States’ actions, it proposes health-related legislation and monitors the said sector through the the **European Commission’s Directorate Generals on Health and Food Safety** (DG SANTE). While it is evident that the Union is in favour of further improving the SRHR, the failure to adopt the {% tooltip Highly criticised by the anti-choice advocates, the so-called 'Estrela report' was a proposed non-binding EU resolution that promoted the right to safe abortion in every Member State. An article with further information on the report and the close vote: https://euobserver.com/social/122418 %}“Estrela report” in 2013{% endtooltip %} proves that the high range of opinions among the Member States makes the organisation take a step back on the issue.
...
**Guaranteeing access to affordable quality health centres** for women of all socioeconomic backgrounds has remained a critical issue particularly in Eastern European states due to the high costs of STI testing, abortion and other services as well as public clinics being viewed as untrustworthy because of cases of violated anonymity. Affordability of such services poses the biggest challenge for the most vulnerable groups such as {% tooltip An opinion piece critical of the EU’s treatment of migrants’ SRHR-related issues: http://www.sciencedirect.com/science/article/pii/S0168851013002881 %}**adolescents, immigrants and Internally Displaced Persons (IDP)**{% endtooltip %}. In addition, the level of availability of health centres tends to be much lower in rural areas. As a result, women frequently refer to life-threatening practices such as {% tooltip Article on alarming rates of unsafe abortion procedures in Eastern Europe: http://www.ipsnews.net/2012/11/unsafe-abortions-threaten-thousands-in-eastern-europe/ %}**unsafe abortion procedures or non-medical diagnostic testings**{% endtooltip %}.
...
Apart from providing constant data, The WHO also created {% tooltip Full document: http://www.euro.who.int/__data/assets/pdf_file/0004/69529/e74558.pdf %}**European regional strategy on sexual and reproductive health** in 2001{% endtooltip %} which served for the time period of 2001-2015. Another action plan for a shorter time period of 2017-2021 is being drafted right now.
